...
import { AdminPosition } from '@/data/positions';
...
export const ROLES_SIDEBARS: Partial<Record<AdminPosition, RoleSideBar>> = {
    ...
    info: ADMIN_SIDEBAR,
    admin: ADMIN_SIDEBAR,
} satisfies Partial<Record<AdminPosition, RoleSideBar>>;
...
export const CDP_SIDEBAR: SideBarGroup[] = [
    {
        ...
        items: [
            ...
            {
                title: 'Écriture MRI (ancienne version)',
                icon: MRI_ICON,
                href: '/mri',
            },
            {
